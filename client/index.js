...
document.getElementById("submit").addEventListener("click", async () => {
    try {
        ...
        const inputTax = document.getElementById("estimatedTax").value;

        show("logs", "Generating witness... ⏳");
        const { witness } = await noir.execute({ raw_data: { total_received: totalReceived, total_expenses: totalExpenses }, input_tax: inputTax });
